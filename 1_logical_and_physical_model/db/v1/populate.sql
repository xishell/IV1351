...
-- CS559P322: employees 26, 22
('CS559P322', 26, 'Course administration', 17),
('CS559P322', 22, 'Tutorial', 31),
-- CS990HT21: employees 26, 8, 9
('CS990HT21', 26, 'Lecture', 68),
('CS990HT21', 8, 'Tutorial', 46),
('CS990HT21', 9, 'Seminar', 64),
-- CS658H123: employee 26
('CS658H123', 26, 'Exam grading', 34),
('CS658H123', 26, 'Project supervision', 47),
('CS658H123', 26, 'Tutorial', 37),
('CS658H123', 26, 'Lab', 17),
-- CS818VT20: employees 4, 13, 28
('CS818VT20', 13, 'Exam grading', 17),
('CS818VT20', 13, 'Project supervision', 16),
('CS818VT20', 13, 'Lecture', 71),
('CS818VT20', 28, 'Seminar', 74),
-- CS658P222: employee 28
('CS658P222', 28, 'Lab', 33),
('CS658P222', 28, 'Lecture', 18),
('CS658P222', 28, 'Project supervision', 18),
('CS658P222', 28, 'Exam grading', 40),
-- CS990P424: employees 8, 7
('CS990P424', 8, 'Lecture', 15),
('CS990P424', 7, 'Project supervision', 20),
('CS990P424', 7, 'Lab', 63),
-- CS754P225: employees 12, 10
('CS754P225', 12, 'Project supervision', 43),
('CS754P225', 12, 'Course administration', 36),
('CS754P225', 10, 'Exam grading', 50),
('CS754P225', 10, 'Seminar', 40),
-- CS658P220: employee 8
('CS658P220', 8, 'Tutorial', 68),
('CS658P220', 8, 'Lab', 50),
('CS658P220', 8, 'Seminar', 19),
-- CS381P422: employee 22
('CS381P422', 22, 'Tutorial', 22),
('CS381P422', 22, 'Project supervision', 19),
-- CS658P325: employee 13
('CS658P325', 13, 'Lab', 54),
('CS658P325', 13, 'Project supervision', 18),
('CS658P325', 13, 'Seminar', 41),
('CS658P325', 13, 'Course administration', 57),
-- CS658VT23: employees 9, 28
('CS658VT23', 28, 'Lab', 48),
('CS658VT23', 9, 'Tutorial', 77),
('CS658VT23', 9, 'Project supervision', 11),
-- CS381P225: employee 25
('CS381P225', 25, 'Course administration', 27),
('CS381P225', 25, 'Project supervision', 43),
('CS381P225', 25, 'Seminar', 24),
('CS381P225', 25, 'Lecture', 23),
-- CS338HT23: employees 12, 21
('CS338HT23', 12, 'Project supervision', 36),
('CS338HT23', 21, 'Lab', 53),
('CS338HT23', 12, 'Seminar', 36),
('CS338HT23', 12, 'Course administration', 43),
-- CS754P220: employees 13, 22, 27
('CS754P220', 22, 'Tutorial', 64),
('CS754P220', 13, 'Seminar', 45),
('CS754P220', 13, 'Lecture', 15),
('CS754P220', 27, 'Project supervision', 10),
-- CS338P221: employees 11, 1, 4
('CS338P221', 11, 'Course administration', 30),
('CS338P221', 1, 'Lab', 33),
('CS338P221', 4, 'Lab', 33),
('CS338P221', 1, 'Seminar', 31),
-- CS658VT21: employees 6, 19
('CS658VT21', 6, 'Tutorial', 19),
('CS658VT21', 6, 'Project supervision', 29),
('CS658VT21', 6, 'Lecture', 79),
('CS658VT21', 19, 'Exam grading', 14),
-- CS854H123: employees 2, 4
('CS854H123', 2, 'Project supervision', 65),
('CS854H123', 2, 'Course administration', 26),
('CS854H123', 4, 'Lab', 15),
-- CS381VT24: employees 14, 12, 24
('CS381VT24', 12, 'Seminar', 36),
('CS381VT24', 14, 'Lecture', 41),
('CS381VT24', 12, 'Course administration', 23),
-- CS754P120: employees 14, 20
('CS754P120', 14, 'Course administration', 29),
('CS754P120', 14, 'Project supervision', 40),
('CS754P120', 20, 'Tutorial', 30),
-- CS854HT23: employees 4, 13, 29
